  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 flex-1 border-r border-gray-200 dark:border-gray-800 w-full lg:w-fit h-full">
        <div className="flex items-center gap-2 px-4 py-3 border-b border-neutral-200 dark:border-neutral-800 rounded-t-md bg-secondary-500 dark:bg-secondary-200 text-base-light dark:text-base-dark lg:rounded-tr-none lg:rounded-tl-md">
          <Icon
      ...
      <div className="flex flex-col gap-3 h-full flex-1 w-full lg:w-fit">
        <div className="flex items-center gap-2 px-4 py-3 border-b border-neutral-200 dark:border-neutral-800 bg-secondary-500 dark:bg-secondary-200 text-base-light dark:text-base-dark lg:rounded-tr-md fr">
          <Icon
